...
set CLASSPATH=%APP_HOME%\lib\java.jar;%APP_HOME%\lib\joda-time-2.2.jar

@rem Execute java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_OPTS%  -classpath "%CLASSPATH%" .Hello %CMD_LINE_ARGS%
